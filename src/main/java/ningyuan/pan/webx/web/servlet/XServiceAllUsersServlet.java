 ...
 *
 */
public class XServiceAllUsersServlet extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private static final Logger LOGGER = LoggerFactory.getLogger(XServiceAllUsersServlet.class);
	...
	protected void doGet(HttpServletRequest reqest, HttpServletResponse response) throws ServletException, IOException {
		...
		// empty users as an array
		String ret = "[]";
		
		if(service != null) {
			ret = service.getAllUsers(TextType.JSON.getName());
